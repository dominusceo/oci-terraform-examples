...
/opt/splunk/bin/splunk init shcluster-config -auth admin:$password -mgmt_uri https://$public_ip:8089 -replication_port 8181  -replication_factor 2 
 -conf_deploy_fetch_url https://$deployer_ip:8089 -secret $shc_pass -shcluster_label demoshcluster
