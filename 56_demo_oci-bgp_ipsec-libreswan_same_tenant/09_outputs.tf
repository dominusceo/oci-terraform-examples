...
output "oci-vcn-instance-public-ip" {
  value = oci_core_instance.oci-vcn-pub-instance.public_ip
}
##################################################################################
...
output "oci-vcn-instance-private-ip" {
  value = oci_core_instance.oci-vcn-pub-instance.private_ip
}
##################################################################################
