...
# ------ Update application spoke VCN route table (Application VCN)
...
# ------ Add Web Private Subnet to Web VCN (Application VCN)
...
# ------ Create route table for Server A Subnet Route Table ((Application VCN))
...
# ------ Create route table for Server B Subnet Route Table (Application VCN)
